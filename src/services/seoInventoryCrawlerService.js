  ...
  async _collectAllSitePages() {
    ...
    const staticList = [
      ...
      },
      {
        ...
        metaDescription: 'Learn about ONPRINT’s industrial printing facility in Al Quoz, Dubai. Advanced Heidelberg offset and HP digital presses serving corporate UAE.',
      ...
      },
      {
        path: '/contact',
        type: 'Contact',
        title: 'Contact ONPRINT Dubai | Al Quoz Pressroom & Showroom',
        metaDescription: 'Contact ONPRINT Dubai. Located in Al Quoz, Dubai. Contact our production team via email or visit our plant.',
        h1: 'Contact ONPRINT Commercial Pressroom & Production Plant',
        h2s: ['Visit Our Al Quoz Facility', 'Direct Pressroom Email & Inquiries', 'Request Urgent Dispatch'],
        wordCount: 540,
