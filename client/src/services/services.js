...
export const defaultServices = [
  ...
  },
  {
    ...
    category: { name: 'Packaging & Custom Boxes' },
  ...
  {
    _id: 'serv-3',
    name: 'Brochures & Catalogs Printing',
    slug: 'brochures-catalogs-printing',
    category: { name: 'Office Stationery Printing' },
    shortDescription: 'Multi-page booklets, saddle-stitched catalogs, bi-fold brochures, and presentation folders.',
    description: 'Showcase your products and services with high-definition multi-page catalog printing, saddle stitching, wire-o binding, and soft-touch laminations.',
