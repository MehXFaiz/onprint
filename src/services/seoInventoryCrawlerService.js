    ...
    const staticList = [
      {
        ...
        h1: 'Precision Commercial Printing & Luxury Packaging in Dubai',
      ...
      },
      {
        ...
        h2s: ['Digital & Offset Capabilities', 'Corporate Stationery Suite', 'Luxury Packaging Production', 'Large Format & Exhibition Displays'],
        wordCount: 820,
