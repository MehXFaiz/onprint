        ...
        <div className="w-full max-w-md rounded-2xl border border-border bg-surface p-8 shadow-xs sm:p-10">
          <div className="text-center">
            ...
            <div className="mt-4 flex items-center justify-center gap-1.5 text-xs font-bold uppercase tracking-wider text-accent">
              ...
              <span>Customer Account Creation</span>
            </div>
            <h1 className="font-display mt-2 text-2xl font-extrabold tracking-tight text-primary">Create Your Account</h1>
            <p className="mt-1 text-xs text-secondary">Track print quotes, artwork approvals, and re-orders easily.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="mt-8 space-y-5">
            ...
            <div>
              <label htmlFor="company" className="text-xs font-bold uppercase tracking-wider text-primary">
            ...
            {notice && (
              <div className="rounded-xl border border-accent/20 bg-accent-soft p-3.5 text-xs font-medium text-primary text-center">
                Registration portal integration is currently being enabled.
              </div>
            )}
