...
import { ShoppingBag, FileText, User, ArrowRight, Clock, CheckCircle2, ShieldCheck, Plus } from 'lucide-react'
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl border border-neutral-200/80 bg-white p-5 shadow-xs">
          ...
          <div className="mt-2 text-3xl font-black text-neutral-900">2</div>
        </div>

        <div className="rounded-2xl border border-neutral-200/80 bg-white p-5 shadow-xs">
          <div className="text-xs font-bold uppercase tracking-wider text-neutral-500">Proof Status</div>
          <div className="mt-2 text-3xl font-black text-emerald-600">Approved</div>
        </div>
      </div>
            ...
            <div key={order._id} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
              <div>
                ...
                <div className="text-neutral-500 mt-0.5">
                  Order #{order.orderNumber} • Qty: {order.quantity} units
                </div>
              </div>
