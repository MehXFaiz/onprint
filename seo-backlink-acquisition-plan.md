...
```mermaid
pie title Natural UAE Backlink Anchor Distribution
    "Branded & Brand + Geo (40%)" : 40
    "Partial Match & Contextual (30%)" : 30
    "Exact Match Target (15%)" : 15
    "Generic & Naked URL (15%)" : 15
```
